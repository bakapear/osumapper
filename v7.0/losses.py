...
def inblock_loss(vg, border, value):
    ...
    wall_var_r = tf.where(tf.greater(vg, 1 - border),
                          tf.square(vg - (1 - value)), 0 * vg)
...
class GenerativeCustomLoss(LossFunctionWrapper):
    ...
    def __init__(self,
        ...
        super(GenerativeCustomLoss, self).__init__(
            loss_function_for_generative_model, name=name, reduction=reduction)
...
class BoxCustomLoss(LossFunctionWrapper):
    ...
    def __init__(self,
        ...
        super(BoxCustomLoss, self).__init__(
            box_loss, name=name, reduction=reduction)
...
class AlwaysZeroCustomLoss(LossFunctionWrapper):
    ...
    def __init__(self,
        ...
        super(AlwaysZeroCustomLoss, self).__init__(
            alw_zero, name=name, reduction=reduction)
